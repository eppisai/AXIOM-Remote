...
InputScreen::InputScreen(IUSBDevice * usbDevice):
...
void InputScreen::Draw(IPainter * painter) {
...
void InputScreen::Update(ButtonID ButtonID, int8_t knob, IMenuSystem * menuSystem) {
